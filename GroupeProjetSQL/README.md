...
La base de données de cIAra Mobility est structurée autour de 4 tables principales relationnelles:
...
Pour répondre aux besoins métier, nous avons adopté une stratégie de complexité croissante :
